<template>
  <TableCard>
    <div class="overflow-x-auto">
      <table
        class="console-table console-table--compact w-full min-w-[1080px]"
        v-loading="loading"
      >
        <thead>
          <tr>
        ...
        <tbody class="divide-y divide-border-light dark:divide-border-dark">
          ...
          >
            ...
            <td>
              <span class="is-secondary is-code">{{ row.storageClass }}</span>
            </td>
            <td class="is-secondary">{{ row.area }}</td>
            <td>
              <span class="is-primary"
                >¥{{ row.storagePriceGb?.toFixed(4) || '0' }}/GB/日</span
              >
            </td>
            ...
            <td class="max-w-[200px] truncate is-secondary">
              {{ row.description }}
            </td>
