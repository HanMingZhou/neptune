<template>
  <div class="flex items-center gap-4 h-14">
    ...
    <div
      class="flex flex-col justify-center text-right px-6 h-full border border-slate-200 dark:border-border-dark rounded-xl bg-white dark:bg-surface-dark shadow-sm"
    >
      <p
        class="text-[10px] font-black uppercase text-slate-400 leading-none mb-1"
      >
