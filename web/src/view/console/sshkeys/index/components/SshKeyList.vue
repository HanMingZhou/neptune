        ...
        <tbody>
          ...
          <tr v-else-if="items.length === 0">
            <td colspan="5" class="px-6 py-12 text-center text-slate-400">
              <div class="flex flex-col items-center gap-3">
                <span class="material-icons text-5xl text-slate-300"
                  >vpn_key</span
                >
                <div class="space-y-1">
                  <p
          ...
          <tr v-for="key in items" v-else :key="key.id">
            ...
            <td class="max-w-[420px]">
              <code
                class="detail-inline-chip is-code block max-w-full truncate"
...
import type { SshKeyListItem } from '@/types/sshkey'
