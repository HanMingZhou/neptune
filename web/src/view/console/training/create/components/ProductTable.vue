        ...
        <tbody class="divide-y divide-border-light dark:divide-border-dark">
          <tr
            ...
            :class="[
              ...
              selectedProductId === product.id ? 'bg-primary/5' : 'hover:bg-slate-50 dark:hover:bg-zinc-800/40'
            ]"
          ...
          >
            <td class="px-6 py-4">
              <div
                :class="[
                  ...
                  selectedProductId === product.id ? 'border-primary' : 'border-slate-300 dark:border-zinc-600'
                ]"
              >
            ...
            <td class="px-6 py-4 text-sm">{{ product.area }}</td>
            <td class="px-6 py-4">
          ...
          <tr v-if="products.length === 0">
            <td colspan="7" class="px-6 py-12 text-center text-slate-400">{{ t('noData') }}</td>
          </tr>
        </tbody>
      </table>
    </div>
