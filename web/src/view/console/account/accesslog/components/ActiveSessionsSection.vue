  ...
  <section class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      >
          ...
          <div class="flex items-center gap-3">
            ...
            >
              <span class="material-icons">
                {{
                  session.device && session.device.includes('iPhone')
                    ? 'smartphone'
                    : 'laptop'
                }}
              </span>
        ...
        <div
          class="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-border-dark text-[10px] text-slate-400"
        >
...
import type { AccessLogSession } from '@/types/account'
import type { ResourceId, Translator } from '@/types/consoleResource'

defineProps<{
  sessions: AccessLogSession[]
}>()
