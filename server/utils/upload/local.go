...
func (*Local) UploadFile(file *multipart.FileHeader) (string, string, error) {
	...
	if mkdirErr != nil {
		logx.Error("function os.MkdirAll() failed", logx.Field("err", mkdirErr))
	...
	if createErr != nil {
		logx.Error("function os.Create() failed", logx.Field("err", createErr))
	...
	if copyErr != nil {
		logx.Error("function io.Copy() failed", logx.Field("err", copyErr))
