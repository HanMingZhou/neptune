...
const (
	SysAuthorityId888  = 888
	SysAuthorityId9528 = 9528
	DefaultAuthorityId = 8881
)

var SysAuthorityIds = map[uint]bool{
	SysAuthorityId888:  true,
	SysAuthorityId9528: true,
}
...
type SysUser struct {
	...
	Namespace     string         `json:"namespace" gorm:"comment:用户命名空间"`                                                                    // 用户命名空间
}
...
func (s *SysUser) GetUserNamespace() string {
	return s.Namespace
}
